...
public class MySQLAccess
{
	...
	public void createSeleniumCalibratedItem(String itemName) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException
	{
		try
		{
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			...
			*/
			...
			connect.prepareStatement("INSERT INTO item (item_id, description, owner_id, user_id, track_id, parent_id, item_type, status, init_loc_id, cur_loc_id, pm_date, pm_interval, num_pm_measures, pm_due_date, def_checkout_time, total_time_checked_out, def_usage_time, total_time_used, pm_cost, total_pm_cost) "
			+ "VALUES ('" + itemName + "', 'Selenium Test Description', '" + user_id + "', '" + user_id + "', 'track', 'N/A', 'Gauge', 'Ready', '" + location_id + "', '" + location_id + "', '2010-01-01 00:00:00', '10', '0', '2010-01-02 00:00:00', '10', '0', '10', '0','10', '0')").executeUpdate();
			
			connect.prepareStatement("INSERT INTO pm (item_id, pm_type, pm_desc, pm_date, user_id, location_id, approval, comments, item_condition, cost, temperature, humidity, pressure) "
					+ "VALUES ('" + itemName + "', 'Calibration', 'Calibration was performed on the device', '01/01/2010', '" + user_id + "', '" + location_id + "', 'Pass', 'Selenium Test Comment', 'Good', '30', '30', '30', '30')").executeUpdate();
